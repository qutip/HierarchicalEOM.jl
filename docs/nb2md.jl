...
function nb2md(file)
    ...
    run(`jupyter nbconvert --to markdown --ExecutePreprocessor.kernel_name=julia-1.8 --ExecutePreprocessor.timeout=1000 --output-dir=$MDdir --template=markdown_template.tpl --execute $NBpath `)
end
