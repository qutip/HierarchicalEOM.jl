module Heom
    ...
    module Bath
        ...
        export 
            AbstractEnvBath, BosonicBath, FermionicBath,
            pade_NmN
    ...
    module HeomBase
        import ..Bath: AbstractEnvBath, BosonicBath, FermionicBath
        import Base: size
        import LinearAlgebra: I, kron
        import OrderedCollections: OrderedDict
        import SparseArrays: sparse, SparseMatrixCSC, AbstractSparseMatrix
    ...
    module evolution
        import ..HeomBase: AbstractHEOMMatrix
        import OrdinaryDiffEq: ODEProblem, init, DP5, step!
        import SparseArrays: spzeros, sparsevec, reshape, SparseMatrixCSC, SparseVector
